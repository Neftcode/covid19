...
$("#mapDropdown").change(function () {
    ...
    function mapReady() {
        ...
        $.each(mapGeoJSON.features, function (index, feature) {
            // console.log(feature.properties['iso-a3'])//iso-a3
            data.push({
                key: feature.properties['hc-key'],
                value: (matrizPaisesJs[feature.properties['iso-a3']] ? matrizPaisesJs[feature.properties['iso-a3']] : 0)
                // value: index
            });
        });
        ...
        $("#container").highcharts('Map', {
            ...
            title: {
                text: "Origen del Covid-19 en Colombia"
            },
